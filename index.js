...
const unfundedGamesCount = unfundedOnly.length;
...
`
    The purpose of our company is to fund independent games. We've been in operation for 100 years.<br><br>
    A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. 
    Currently, ${unfundedGamesCount} game${unfundedGamesCount === 1 ? '' : 's'} remain unfunded. We need your
